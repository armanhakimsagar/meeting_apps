    ...
    <section class="wrapper">
        <div class="panel">
            ...
            <table  class="table">
                ...
                <tbody>
                    @if(session()->has('companies_dependency'))
                <div class="alert alert-success">
                    {{ session()->get('companies_dependency') }}
                </div>
                @endif
                @if(session()->has('mind_shares_dependency'))
                <div class="alert alert-success">
                    {{ session()->get('mind_shares_dependency') }}
                </div>
                @endif

                @if(session()->has('question_replies_dependency'))
                <div class="alert alert-success">
                    {{ session()->get('question_replies_dependency') }}
                </div>
                @endif
                ...
                @endif    
                @if(session()->has('mind_share'))
                <div class="alert alert-success">
                    {{ session()->get('mind_share') }}
                </div>
                @endif  
                @if(session()->has('question_reply'))
                <div class="alert alert-success">
                    {{ session()->get('question_reply') }}
                </div>
                @endif  
                @if(session()->has('company_msg'))
                <div class="alert alert-success">
                    {{ session()->get('company_msg') }}
                </div>
                @endif  
                ...
                <tr>
                    ...
                    <td>{{ $ud->email }}</td>
                    <td>{{ $ud->phone }}</td>
                    <td>{{ $ud->designation }}</td>
                    <td><a  class="btn btn-success" href="{{ url('admin/edit_user/'.$ud->id) }}"  ><i class="fa fa-edit"></i></a>
                        <a class="btn btn-danger delete" href="{{ url('admin/delete_user/'.$ud->id) }}"><i class="fa fa-trash-o"></i></a>
                    </td> 
