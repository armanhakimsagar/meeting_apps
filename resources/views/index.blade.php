            ...
            <div class="col-lg-7">
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <form role="form" class="form-horizontal tasi-form" method="post" action="{{ url('admin/post_meeting') }}">
                            <div class="form-group">
                                <label for="inputPassword1" class="col-lg-2 col-sm-2 control-label">Title</label>
                                <div class="col-lg-10">
                                    <input type="text" value="{{ old('title') }}" class="form-control" id="inputPassword1" name="title" placeholder="Type title">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" value="{{ old('description') }}" class="form-control" id="inputPassword1" name="description" placeholder="Type description">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" value="{{ old('start_time') }}" class="form-control" id="basicExample1" name="start_time" placeholder="Start Time">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" value="{{ old('end_time') }}" class="form-control" id="basicExample2" name="end_time" placeholder="End Time">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" value="{{ old('location') }}" class="form-control" id="inputPassword1" name="location" placeholder="Type location">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" value="{{ old('code') }}" class="form-control" id="inputPassword1" name="code" placeholder="Type code">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" value="{{ old('presenter') }}" class="form-control" id="inputPassword1" name="presenter" placeholder="Type presenter name here">
                                </div>
                            </div>
...
@section('footer_js_scrip_area')
    ...
    <script src="{{ asset('js/agenda_loop.js') }}"></script>
    @endsection
@endsection
